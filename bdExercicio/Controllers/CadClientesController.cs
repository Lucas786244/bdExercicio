...
using bdExercicio.Data;
using bdExercicio.Models;

namespace bdExercicio.Controllers
{
    public class CadClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCliente,Nome,Sobrenome,CPF")] CadClientes cadClientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCliente,Nome,Sobrenome,CPF")] CadClientes cadClientes)
        {
